...
class MysqlTool:
    ...
    def __init__(self,host="127.0.0.1",port=3306,user="root",password="123456",database="anhui_local_test",charset="utf8"):
    ...
    def insertContract(self,datalist):
        ...
        sql = "insert into mlt_data_private(" \
              "unit_id,date,mlt_sort,start_date,end_date,ele,price,unit_name,opposite_side,mlt_type,trade_direction,contract_name) " \
